        ...
        >
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-top:6px;">
                ...
                <button
                    ...
                    style="appearance:none;border:0;width:36px;height:36px;border-radius:999px;display:flex;align-items:center;justify-content:center;background:{{ $hasComposerContent ? 'var(--w-ink)' : 'var(--w-line-2)' }};color:{{ $hasComposerContent ? '#FAF8F2' : 'var(--w-muted)' }};cursor:{{ $hasComposerContent ? 'pointer' : 'not-allowed' }};"
                >
